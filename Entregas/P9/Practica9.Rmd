...
### Significacion individual de las variables explicativas
Para x<sub>1</sub> no hay evidencia suficiente para rechazar la hip nula al 5% de significacion.

Repetimos el procedimiento anterior para otras percepciones *x<sub>2</sub>...x<sub>7</sub>*.
...
para rechazar la hipotesis nula al 5% de significacion, por lo que la 
...
Representamos para cada percepcion x_j los grafos de dispersion de los pares
(x_ij,r_i).
